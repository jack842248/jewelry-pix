<template>
    <div style="margin-top:90px">
        <section
            class="category-hero"
            :style="{ backgroundImage: `url(${require('@/assets/images/img-hero-crystal-bracelets.jpg')})` }">
            <div class="container h-100">
                <div class="row flex-column justify-content-end h-100">
                    <div class="text-right">
                        <h2 class="pr-3">水晶手環</h2>
...
export default {
    ...
    computed:{
        ...
        products: function(){
            return this.$store.state.frontend.products.filter(item=>item.content == '水晶手環')
        },
