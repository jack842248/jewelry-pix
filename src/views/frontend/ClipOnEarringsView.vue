<template>
    <div style="margin-top:90px">
        <section
            class="category-hero"
            :style="{ backgroundImage: `url(${require('@/assets/images/img-hero-clip-on-earrings.jpg')})` }">
            <div class="container h-100">
                <div class="row flex-column justify-content-end h-100">
                    <div class="text-right">
                        <h2 class="pr-3">耳夾耳環系列</h2>
...
export default {
    ...
    computed:{
        ...
        products: function(){
            return this.$store.state.frontend.products.filter(item=>item.content == '耳夾耳環系列')
        },
